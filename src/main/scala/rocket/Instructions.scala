...
object Instructions {
  ...
  def BNDR               = BitPat("b0000000??????????001?????1100111")
  //def BNDI               = BitPat("b?????????????????100?????1100111")
  def SBDU               = BitPat("b?????????????????010?????1100111")
  def SBDL               = BitPat("b?????????????????011?????1100111")
  def LBDU               = BitPat("b?????????????????101?????1100111")
  def LBDL               = BitPat("b?????????????????110?????1100111")
  def LBDUS              = BitPat("b?????????????????111?????1100111")
  def LBDLS              = BitPat("b?????????????????100?????1100111")
  def LB_B               = BitPat("b?????????????????000?????0001011")
  def LH_B               = BitPat("b?????????????????001?????0001011")
  def LW_B               = BitPat("b?????????????????010?????0001011")
  def LD_B               = BitPat("b?????????????????011?????0001011")
  def LBU_B              = BitPat("b?????????????????100?????0001011")
  def LHU_B              = BitPat("b?????????????????101?????0001011")
  def LWU_B              = BitPat("b?????????????????110?????0001011")
  def SB_B               = BitPat("b?????????????????100?????0101011")
  def SH_B               = BitPat("b?????????????????101?????0101011")
  def SW_B               = BitPat("b?????????????????110?????0101011")
  def SD_B               = BitPat("b?????????????????111?????0101011")
